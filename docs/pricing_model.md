...
- 무료 플랜: 25MB
- 월간 플랜: 300MB, 9,900원/월
- 연간 플랜: 500MB, 연간 10% 할인 적용(월 9,900원 대비 연 106,920원)
...
프론트엔드/백엔드 플랜 정책은 `app/services/subscription_plans.py`의 상수로 단일 소스처럼 관리하고, `app/api/v1/conversion.py`에서 업로드 한도를 강제합니다.
